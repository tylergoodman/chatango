...
var User = (function (_super) {
    ...
    User.prototype.setStyle = function (style) {
        ...
        style = lodash_1.assign(this.style, style);
        var data = lodash_1.transform(style, function (result, value, key) {
    ...
    User.prototype.setBackground = function (background) {
        ...
        background = lodash_1.assign(this.background, background);
        return new Promise(function (resolve, reject) {
            request({
